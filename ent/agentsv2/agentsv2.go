...
const (
	// Label holds the string label denoting the agentsv2 type in the database.
	Label = "agents_v2"
	...
	// Table holds the table name of the agentsv2 in the database.
	Table = "agents_v2s"
)

// Columns holds all SQL columns for agentsv2 fields.
var Columns = []string{
	FieldID,
	FieldStatus,
...
// OrderOption defines the ordering options for the AgentsV2 queries.
